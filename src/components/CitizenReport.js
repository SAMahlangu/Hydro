            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={6}
                  className="w-full border-2 border-water-pale rounded-lg px-4 py-3 focus:ring-2 focus:ring-water-primary focus:border-water-primary transition-all bg-white font-body resize-none"
                  placeholder="Enter your water-related report here... (e.g., 'Leak detected in the main water pipeline near downtown.')"
                />
              </div>
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  disabled={loading || !form.model_name || !form.report_text.trim()}
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="bg-water-pale/30 rounded-lg p-4 border border-water-pale/50">
                    <p className="text-water-dark font-body leading-relaxed">{result.summary}</p>
                  </div>
                </div>
